...
import pers.xumeng.androidstudy.http.request.scheme3.UserRepository3;
...
public class LoginViewModel extends ViewModel {
  ...
  private final UserRepository3 repository3 = new UserRepository3(message);
  ...
  public void login3(String userName, String password) {
    ...
    repository3.login(userName, password, loginResult);
  }
